...
@pytest.mark.django_db
def test_comment_admin_patch(api_admin_client, admin_api, ad):
    comment = Comment.objects.create(text="text", ad=ad, author=admin_api)
    ...
    expected_response = {
        ...
        "created_at": response.data.get("created_at"),
        "author_first_name": admin_api.first_name,
        "author_last_name": admin_api.last_name,
        "ad_id": ad.pk,
        "author_image": None
    }
